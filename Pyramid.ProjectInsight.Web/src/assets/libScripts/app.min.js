    ...
    $.AdminLTE.layout = {
        ...
        fix: function() {
            var a = $(".main-header").outerHeight() + $(".main-footer").outerHeight(),
                b = $(window).height(),
                c = $(".sidebar").height();
            if ($("div").hasClass("fixed")) $(".content-wrapper, .right-side").css("min-height", b - $(".main-footer").outerHeight());
            else {
                var d;
        ...
        fixSidebar: function() {
            return $("div").hasClass("fixed") ? ("undefined" == typeof $.fn.slimScroll && window.console && window.console.error("Error: the fixed layout requires the slimscroll plugin!"), void($.AdminLTE.options.sidebarSlimScroll && "undefined" != typeof $.fn.slimScroll && ($(".sidebar").slimScroll({
                destroy: !0
        ...
        activate: function(a) {
            ...
            $(document).on("click", a, function(a) {
                a.preventDefault(), $(window).width() > b.sm - 1 ? $("div").hasClass("sidebar-collapse") ? $("div").removeClass("sidebar-collapse").trigger("expanded.pushMenu") : $("div").addClass("sidebar-collapse").trigger("collapsed.pushMenu") : $("div").hasClass("sidebar-open") ? $("div").removeClass("sidebar-open").removeClass("sidebar-collapse").trigger("collapsed.pushMenu") : $("div").addClass("sidebar-open").trigger("expanded.pushMenu")
            }), $(".content-wrapper").click(function() {
                $(window).width() <= b.sm - 1 && $("div").hasClass("sidebar-open") && $("div").removeClass("sidebar-open")
            }), ($.AdminLTE.options.sidebarExpandOnHover || $("div").hasClass("fixed") && $("div").hasClass("sidebar-mini")) && this.expandOnHover()
        },
        expandOnHover: function() {
            var a = this,
                b = $.AdminLTE.options.screenSizes.sm - 1;
            $(".main-sidebar").hover(function() {
                $("div").hasClass("sidebar-mini") && $("div").hasClass("sidebar-collapse") && $(window).width() > b && a.expand()
            }, function() {
                $("div").hasClass("sidebar-mini") && $("div").hasClass("sidebar-expanded-on-hover") && $(window).width() > b && a.collapse()
            })
        },
        expand: function() {
        ...
        collapse: function() {
            $("div").hasClass("sidebar-expanded-on-hover") && $("div").removeClass("sidebar-expanded-on-hover").addClass("sidebar-collapse")
        }
    },
	 ...
	 $.AdminLTE.tree = function(a) {
        ...
        $(a).on("click", "li a", function(a) {
            var d = $(this),
                e = d.next();
            if (e.is(".treeview-menu") && e.is(":visible") && !$("div").hasClass("sidebar-collapse")) e.slideUp(c, function() {
        ...
        activate: function() {
            ...
            d.on("click", function(d) {
                d.preventDefault(), c.hasClass("control-sidebar-open") || $("div").hasClass("control-sidebar-open") ? a.close(c, b.slide) : a.open(c, b.slide)
            });
            var e = $(".control-sidebar-bg");
            a._fix(e), $("div").hasClass("fixed") ? a._fixForFixed(c) : $(".content-wrapper, .right-side").height() < c.height() && a._fixForContent(c)
        },
        open: function(a, b) {
            b ? a.addClass("control-sidebar-open") : $("div").addClass("control-sidebar-open")
        },
        close: function(a, b) {
            b ? a.removeClass("control-sidebar-open") : $("div").removeClass("control-sidebar-open")
        },
        _fix: function(a) {
            var b = this;
            $("div").hasClass("layout-boxed") ? (a.css("position", "absolute"), a.height($(".wrapper").height()), $(window).resize(function() {
                b._fix(a)
            })) : a.css({
                position: "fixed",
                height: "auto"
        ...
        collapse: function(a) {
            var b = this,
                ...
                d = c.find("> .box-div, > .box-footer, > form  >.box-div, > form > .box-footer");
...
$.AdminLTE = {}, $.AdminLTE.options = {
        ...
        "use strict";
        $("div").removeClass("hold-transition"), "undefined" != typeof AdminLTEOptions && $.extend(!0, $.AdminLTE.options, AdminLTEOptions);
        ...
        }).css("width", "100%"), a.sidebarPushMenu && $.AdminLTE.pushMenu.activate(a.sidebarToggleSelector), a.enableBSToppltip && $("div").tooltip({
            selector: a.BSTooltipSelector
        }), a.enableBoxWidget && $.AdminLTE.boxWidget.activate(), a.enableFastclick && "undefined" != typeof FastClick && FastClick.attach(document.div), a.directChat.enable && $(document).on("click", a.directChat.contactToggleSelector, function() {
        ...
        a.fn.boxRefresh = function(b) {
            ...
            return this.each(function() {
                ...
                f.on("click", function(a) {
                    a.preventDefault(), c(b), b.find(".box-div").load(e.source, function() {
                        d(b)
                    })
                })
            })
